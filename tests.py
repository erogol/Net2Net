...
class TestOperators(unittest.TestCase):
    ...
    def test_deeper(self):
        ...
        s = deeper(net._modules['conv1'], nn.ReLU, bnorm_flag=True)
        net._modules['conv1'] = s

        s2 = deeper(net._modules['conv2'], nn.ReLU, bnorm_flag=True)
        net._modules['conv2'] = s2

        s3 = deeper(net._modules['fc1'], nn.ReLU, bnorm_flag=False)
        net._modules['fc1'] = s3
